...
(function() {
  ...
  attachSubnavHandler = function() {
    var $nextLink, $prevLink, $program_id, $program_name, $school_id, $school_name, $subnavNext, $subnavPrev, $subnavProgramId, $subnavProgramName, $subnavSchoolId, $subnavSchoolName, $subnavText, $subnavToday, $title, $todayLink;
    ...
    return $subnavProgramId.html($program_id);
  };
...
(function() {
  var attachCourseColumnHandler, attachCourseDeleteHandler, attachCourseEventHandler, attachCourseSubmitHandler;

  attachCourseColumnHandler = function() {
    return $("div.wc-day-column-inner.course-cal").css("cursor", "pointer").on("click", function() {
      var date;
      date = $(this).data("date");
      $.get("/courses/new?date=" + date + "&program_id=" + $(".wc-container").data("program"), function(data, status) {
  ...
  attachCourseEventHandler = function() {
    return $("div.wc-cal-event.course-cal").on("click", function() {
      var eventId;
      eventId = $(this).data("eventid");
      $.data($("#course-modal-delete")[0], "eventid", eventId);
      $.get("/courses/" + eventId + "/edit", function(data, status) {
        $("#course-modal-body").html($(data).filter("#course-form-body").html());
        $("#course-form-submit").hide();
  ...
  attachCourseSubmitHandler = function() {
    return $("#course-modal-confirm").on("click", function() {
      var $form;
      $form = $("form.course");
      $.ajax({
        type: $form.attr("method"),
        ...
        success: function(data, status) {
          ...
          return $.get(document.URL, function(data, status) {
            ...
            return attachCourseEventHandler();
          });
        },
        error: function(data, status) {
          return $("#course-modal-body").html($(data.responseText).find("#course-form-body").html());
        }
      });
      return false;
    });
  ...
  attachCourseDeleteHandler = function() {
    return $("#course-modal-delete").on("click", function() {
      var eventId;
      eventId = $(this).data("eventid");
      return $.ajax({
        type: "POST",
...
(function() {
  var attachHandler, attachNewProgramHandler, attachSubmitHandler, attachTagClickHandler, attachTooltipHandler;
  ...
  attachHandler = function() {
    ...
    $(".teacher-options").on("select2-blur", function() {
      return $.ajax({
        type: "POST",
    ...
    $(".student-options").on("select2-blur", function() {
      return $.ajax({
        type: "POST",
    ...
    $(".teacher-options").on("change", function() {
      return attachTagClickHandler();
    });
    return $(".student-options").on("change", function() {
      return attachTagClickHandler();
    });
  };

  attachNewProgramHandler = function() {
    return $(".new-program").on("click", function(e) {
      var href;
      e.preventDefault();
      href = $(this).attr("href");
      return $.get(href + "?school_id=" + $(this).data("school"), function(data, status) {
        $("#new-program-modal-body").html($(data).find("#new-program-form-body").html());
        attachHandler();
        return $("#new-program-modal").modal({
          keyboard: true
        });
      });
    });
  ...
  attachSubmitHandler = function() {
    return $("#new-program-modal-confirm").on("click", function() {
      var $form;
      ...
      return $.ajax({
        ...
        error: function(data, status) {
          return $("#new-program-modal-body").html($(data.responseText).find("#new-program-form-body").html());
        }
      });
    });
  };
...
(function() {
  var addStudentHandler, addStudentModalSubmitHandler, initDropdown, initRosterEditable, newRosterHandler, rosterModalSubmitHandler, updateClassHandler, updateClassModalSubmitHandler;
