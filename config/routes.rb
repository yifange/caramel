Caramel::Application.routes.draw do
  ...
  resources :events, :month_events, :calendars, :attendances, :navs, :lunchpads, :courses, :rosters, :password_resets, :schedules, :staffs, :teachers, :regions, :programs, :instruments, :students, :profiles, :admins, :program_types, :schools
