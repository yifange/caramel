...
(function() {
  var attachAttendanceGridHandler, attachDeleteHandler, attachModalXeditableFieldsHandler, attachSubmitHandler;

  attachModalXeditableFieldsHandler = function() {
    return $("#attendance-form-course").editable();
  };

  attachAttendanceGridHandler = function() {
    $("a.class-day").tooltip();
    return $("a.fmc-grid-link").on("click", function(e) {
      var editing, href;
      e.preventDefault();
      href = $(this).attr("href");
  ...
  attachSubmitHandler = function() {
    return $("#attendance-modal-confirm").on("click", function() {
      var $form;
      ...
      return $.ajax({
        ...
        success: function(data, status) {
          ...
          return $.get(document.URL, function(data, status) {
            $(".fmc-container").html($(data).find(".fmc-container").html());
            return attachAttendanceGridHandler();
          });
        },
        error: function(data, status) {
          return $("#attendance-modal-body").html($(data.responseText).find("#attendance-form-body").html());
        }
      });
    });
  };
  ...
  attachDeleteHandler = function() {
    return $("#attendance-modal-delete").on("click", function() {
      var attendanceId;
...
(function() {
  var attachColumnHandler, attachDayGridHandler, attachDeleteHandler, attachEventHandler, attachRadioHandler, attachSubmitHandler, attachSubnavHandler;

  attachDayGridHandler = function() {
    return $("td.day-text").on("click", function() {
      var day, month, year;
      year = $(this).data("year");
      month = $(this).data("month");
      day = $(this).data("day");
      return window.location.href = "/calendars/week?year=" + year + "&month=" + month + "&day=" + day;
    });
  };

  attachColumnHandler = function() {
    return $("div.wc-day-column-inner.calendar-cal.editable").css("cursor", "pointer").on("click", function() {
      var date;
      date = $(this).data("date");
      $.get("/calendars/new?date=" + date + "&school_id=" + $(".wc-container").data("school"), function(data, status) {
  ...
  attachEventHandler = function() {
    return $("div.wc-cal-event.calendar-cal.editable").on("click", function() {
      var eventId;
      eventId = $(this).data("eventid");
      $.data($("#calendar-modal-delete")[0], "eventid", eventId);
      $.get("/calendars/" + eventId + "/edit", function(data, status) {
        $("#calendar-modal-body").html($(data).filter("#calendar-form-body").html());
        $("#calendar-form-submit").hide();
  ...
  attachSubmitHandler = function() {
    return $("#calendar-modal-confirm").on("click", function() {
      var $form;
      $form = $("form.calendar");
      return $.ajax({
        type: $form.attr("method"),
        ...
        error: function(data, status) {
          return $("#calendar-modal-body").html($(data.responseText).find("#calendar-form-body").html());
        }
      });
    });
  };
  ...
  attachDeleteHandler = function() {
    return $("#calendar-modal-delete").on("click", function() {
      var eventId, recurring;
      eventId = $(this).data("eventid");
  ...
  attachSubnavHandler = function() {
    var $nextLink, $prevLink, $subnavNext, $subnavPrev, $subnavText, $subnavToday, $title, $todayLink;
    ...
    return $subnavText.html($title);
  };

  attachRadioHandler = function() {
...
(function() {
  $(function() {
    ...
    $(".dropdown-menu.strange").on("click", "#show-in-calendar", function(e) {
      e.preventDefault();
      return alert('helo');
    });
    $(".hah").tooltip({
...
(function() {
  var attachTagClickHandler, attachTooltipHandler, initAllSelection, initDeleteEntry, initNewAndDelete, initNewEntry, initSelection, initSubmit, initXEditable, studentProgramsRefresh, studentSchoolRefresh, teacherProgramsRefresh, teacherRegionsRefresh;
  ...
  initXEditable = function() {
    ...
    return $('.x-editable-password').editable({
      type: "password"
    });
  };

  initDeleteEntry = function(refresh) {
    return $('.delete-entry').on("click", function(e) {
      var deleteList, toBeDelete;
      deleteList = [];
      toBeDelete = "input[type=checkbox]:checked";
      $(toBeDelete).each(function(i, val) {
        return deleteList.push($(this).val());
      });
      return $.ajax({
        type: "POST",
        data: {
        ...
        success: function(data, status) {
          ...
          return initXEditable();
        }
      });
    });
  };

  initSubmit = function(refresh) {
    return $(".new-entry-modal-confirm").on("click", function() {
      var $form;
      $form = $("form.new_entry");
      return $.ajax({
        type: $form.attr("method"),
        ...
        error: function(data, status) {
          return $(".error-message").html($(data.responseText).find(".error-message").html());
        }
      });
    });
  };
  ...
  initNewEntry = function() {
    $(".new-entry").on("click", function(e) {
      ...
      e.preventDefault();
      href = $(this).attr("href");
      return $.get(href + "?entry_identity=" + identity, function(data, status) {
        $(".new-entry-modal-body").html($(data).find(".new-entry-form-body").html());
        return $(".new-entry-modal").modal({
          keyboard: true
        });
      });
    });
    return $(".new-program-entry").on("click", function(e) {
      var cur_pane_id, href, identity;
      identity = $(this).data("entry");
      e.preventDefault();
      href = $(this).attr("href");
      cur_pane_id = $(".active .school-pane.tab-pane.active").attr("id").replace("tab-school", "");
      return $.get(href + "?school_id=" + cur_pane_id, function(data, status) {
        $(".new-entry-modal-body").html($(data).find(".new-entry-form-body").html());
        return $(".new-entry-modal").modal({
          keyboard: true
        });
  ...
  attachTagClickHandler = function() {
    var clickHandlerA;
    clickHandlerA = function() {
      $(".select2-search-choice").unbind("click");
      $(".select2-search-choice").bind("click", clickHandlerA);
      return $(function() {
        return $(".select2-search-choice").popover();
      });
    };
    return $(".select2-search-choice").bind("click", clickHandlerA);
  };

  attachTooltipHandler = function() {
    return $("a.tab-hover").tooltip({
      placement: "bottom"
    });
  };

  teacherRegionsRefresh = function(id, data) {
    $("#collapse" + id + '-').html($(data).find("#collapse" + id + '-').html());
    return initSelection(teacherProgramsRefresh, '#collapse' + id + '-', 'teacher-programs');
  };

  teacherProgramsRefresh = function(id, data) {
    $(".teacher-regions-" + id + '-').parent().html($(data).find(".teacher-regions-" + id + '-').parent().html());
    return initSelection(teacherRegionsRefresh, '', 'teacher-regions-' + id + '-');
  };

  studentProgramsRefresh = function(id, data) {
    $(".student-school-" + id + '-').parent().html($(data).find(".student-school-" + id + '-').parent().html());
    return initSelection(studentSchoolRefresh, '', 'student-school-' + id + '-');
  };

  studentSchoolRefresh = function(id, data) {
    $(".student-programs-" + id + '-').parent().html($(data).find(".student-programs-" + id + '-').parent().html());
    return initSelection(studentProgramsRefresh, '', 'student-programs-' + id + '-');
  };

  initSelection = function(refresh, parent, selector) {
    $.fn.editable.defaults.mode = 'inline';
    $(parent + " [class*=" + selector + "]").select2({
      width: '100%'
    });
    return $(parent + " [class*=" + selector + "]").on("change", function(e) {
      var data;
      data = {
        pk: $(this).data("pk"),
        name: $(this).data("name")
  ...
  initAllSelection = function(parent) {
    ...
    return initSelection('', parent, 'program-type');
  };

  initNewAndDelete = function() {
    initNewEntry();
    initSubmit();
    return initDeleteEntry();
  };
...
(function() {
  var attachProfileHandler;

  attachProfileHandler = function() {
    $.fn.editable.defaults.mode = 'inline';
    return $('.email-input').editable({
      showbuttons: false,
      onblur: 'submit',
      data: function() {
...
(function() {
  var buttonTextFunc, buttonTitleFunc, hideAllButtonHandler, initTooltip, multiselectConfigs, multiselectInit;

  buttonTextFunc = function(singularText, pluralText, maxNum, options) {
    var caret;
    caret = "<b class='caret'></b>";
    if (options.length === 0) {
      return singularText + " " + caret;
    } else if (options.length > maxNum) {
      return options.length + " " + pluralText + " " + caret;
    } else {
      return buttonTitleFunc(options) + " " + caret;
    }
  };

  buttonTitleFunc = function(options) {
    var selected;
    selected = [];
    options.each(function() {
  ...
  multiselectConfigs = function(singular, plural, dropRight) {
    return {
      buttonText: function(options) {
        return buttonTextFunc(singular, plural, 1, options);
      },
      buttonTitle: function(options) {
        return buttonTitleFunc(options);
      },
  ...
  multiselectInit = function() {
    ...
    return $(".multiselect#student-filter").multiselect(multiselectConfigs("student", "students", false));
  };

  hideAllButtonHandler = function() {
    return $(".hide-all").on("click", function() {
      var $icon;
      $icon = $(this).children();
      $icon.toggleClass("icon-eye-close").toggleClass("icon-eye-open");
      if ($icon.hasClass("icon-eye-close")) {
        $(this).attr("title", "Hide all details");
        return $(".accordion-body").show(50);
      } else {
        $(this).attr("title", "Show all details");
        return $(".accordion-body").hide(50);
      }
    });
  };

  initTooltip = function() {
    return $("span.report-stats[data-toggle=tooltip],span.report-header[data-toggle=tooltip]").tooltip({
      container: "body"
    });
  };
...
(function() {
  var accordionHandler, addClassHandler, addClassModalSubmitHandler, addStudentHandler, addStudentModalSubmitHandler, initDropdown, initRosterEditable, newRosterHandler, rosterModalSubmitHandler, studentsSelect, updateClassHandler, updateClassModalSubmitHandler;

  initRosterEditable = function() {
    ...
    return $(".x-editable.roster-notes").editable({
      type: "textarea",
      onblur: "submit",
  ...
  newRosterHandler = function() {
    return $(".new-roster").on("click", function(e) {
      var href;
      e.preventDefault();
      href = $(this).attr("href");
      $.get(href, function(data, status) {
        $("#roster-modal-body").html($(data).filter("#roster-form-body").html());
        return $("#roster-modal").modal({
          keyboard: true
        });
      });
      return false;
  ...
  addStudentHandler = function() {
    return $(".menu-item-add-student").on("click", function(e) {
      var href;
      e.preventDefault();
      href = $(this).attr("href");
      $.get(href, function(data, status) {
        $("#add-student-modal-body").html($(data).filter("#roster-add-student-form-body").html());
        return $("#add-student-modal").modal({
          keyboard: true
        });
      });
      return false;
  ...
  addClassHandler = function() {
    return $(".btn.add-class").on("click", function(e) {
      var href;
      e.preventDefault();
      href = $(this).attr("href");
      $.get(href, function(data, status) {
        $("#add-class-modal-body").html($(data).filter("#course-form-body").html());
        return $("#add-class-modal").modal({
          keyboard: true
        });
      });
      return false;
  ...
  updateClassHandler = function() {
    return $(".menu-item-update-class").on("click", function(e) {
      var href;
      e.preventDefault();
      href = $(this).attr("href");
      return $.get(href, function(data, status) {
        $("#update-class-modal-body").html($(data).filter("#course-form-body").html());
        return $("#update-class-modal").modal({
          keyboard: true
        });
      });
    });
  ...
  addStudentModalSubmitHandler = function() {
    return $("#add-student-modal-confirm").on("click", function() {
      var $form;
      $form = $("form.roster");
      return $.ajax({
        type: $form.attr("method"),
        ...
        error: function(data, status) {
          return $("#add-student-modal-body").html($(data.responseText).find("#roster-add-student-form-body").html());
        }
      });
    });
  };

  rosterModalSubmitHandler = function() {
    return $("#roster-modal-confirm").on("click", function() {
      var $form;
      $form = $("form.roster");
      $.ajax({
        type: $form.attr("method"),
        ...
        error: function(data, status) {
          return $("#roster-modal-body").html($(data.responseText).find("#roster-form-body").html());
        }
      });
      return false;
    });
  ...
  updateClassModalSubmitHandler = function() {
    return $("#update-class-modal-confirm").on("click", function() {
      var $form;
      $form = $("form.course");
      return $.ajax({
        type: $form.attr("method"),
        ...
        error: function(data, status) {
          return $("#update-class-modal-body").html($(data.responseText).find("#course-form-body").html());
        }
      });
    });
  };

  addClassModalSubmitHandler = function() {
    return $("#add-class-modal-confirm").on("click", function() {
      var $form;
      $form = $("form.course");
      return $.ajax({
        type: $form.attr("method"),
        ...
        error: function(data, status) {
          return $("#add-class-modal-body").html($(data.responseText).find("#course-form-body").html());
        }
      });
    });
  };
  ...
  accordionHandler = function() {
    return $(".accordion-parent").on("click", ".accordion-toggle", function() {
      var target;
      target = $(this).data("target");
      return $(".accordion-body#" + target).toggle(50);
    });
  };

  studentsSelect = function() {
    return $(".roster-class-students").select2({
      width: "100%",
      ...
      if (e.added) {
        ...
        return $.post("/rosters", {
          ...
          return $.get(document.URL, function(data, status) {
            $(".rosters-container").html($(data).find(".rosters-container").html());
            newRosterHandler();
            return initRosterEditable();
          });
        });
      } else if (e.removed) {
        enrollmentId = e.removed.id;
        return $.post("/rosters/remove", {
          _method: "DELETE",
          course_id: courseId,
          enrollment_id: enrollmentId
        }, function() {
...
(function() {
  var attachScheduleColumnHandler, attachScheduleDeleteHandler, attachScheduleEventHandler, attachScheduleSubmitHandler, newClassNameInput;

  newClassNameInput = function() {
    ...
    $("a#schedule-name-select").on("click", function(e) {
      e.preventDefault();
    ...
    $("a#schedule-name-new").on("click", function(e) {
      e.preventDefault();
      $("#schedule-course-select").hide();
      $("#schedule-course-name").show();
      return $("#schedule-course-type").show();
    });
    return $("#schedule-course-name").hide();
  };

  attachScheduleColumnHandler = function() {
    return $("div.wc-day-column-inner.schedule-cal").css("cursor", "pointer").on("click", function() {
      var date;
      date = $(this).data("date");
      $.get("/schedules/new?date=" + date + "&program_id=" + $(".wc-container").data("program"), function(data, status) {
  ...
  attachScheduleEventHandler = function() {
    return $("div.wc-cal-event.schedule-cal").on("click", function() {
      var eventId;
      eventId = $(this).data("eventid");
      $.data($("#schedule-modal-delete")[0], "eventid", eventId);
      $.get("/schedules/" + eventId + "/edit", function(data, status) {
        $("#schedule-modal-body").html($(data).filter("#schedule-form-body").html());
        $("#schedule-form-submit").hide();
        $("#schedule-course-name").hide();
        $("#schedule-course-type").hide();
  ...
  attachScheduleSubmitHandler = function() {
    return $("#schedule-modal-confirm").on("click", function() {
      var $form;
      $form = $("form.schedule");
      $.ajax({
        type: $form.attr("method"),
        ...
        success: function(data, status) {
          ...
          return $.get(document.URL, function(data, status) {
            ...
            return attachScheduleEventHandler();
          });
        },
        error: function(data, status) {
          return $("#schedule-modal-body").html($(data.responseText).find("#course-form-body").html());
        }
      });
      return false;
    });
  ...
  attachScheduleDeleteHandler = function() {
    return $("#schedule-modal-delete").on("click", function() {
      var eventId, recurring;
      eventId = $(this).data("eventid");
...
(function ($) {
  ...
  userName.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
    tpl: '<div class="x-editable-user-name"><input type="text" name="first_name" class="input-small name-input" placeholder="first name"><input type="text" name="last_name" class="input-small" placeholder="last name"></div>',
    inputclass: ''
  });
