Caramel::Application.routes.draw do
  ...
  resources :events, :month_events, :calendars, :attendances, :navs, :lunchpads, :courses, :rosters, :password_resets, :schedules, :users, :staffs, :teachers, :regions, :programs, :instruments, :students, :admins, :program_types, :schools, :reports
